    ...
    <Layout>
      {data ? (
        <div
          ...
          className="flex flex-col md:flex-row w-full items-center justify-center md:mt-40"
        >
          ...
          <div
            data-aos="fade-right"
            data-aos-duration="1500"
            className="flex flex-col shadow-xl bg-blue-200 p-10 md:w-1/2 py-20 rounded-lg md:text-lg m-8 leading-6"
          >
            <p className="my-2">
